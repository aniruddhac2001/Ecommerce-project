...
<body>
    ...
    <section id="header">
        ...
        <div>
            <ul id="navbar">
                ...
                <li><a href="index.php" class="button3"><?php echo $_SESSION['username']; ?></a></li>
            </ul>
        </div>
    </section>
    ...
    <section id="product1" class="section-p1">
        ...
        <div class="pro-container">
            <div class="pro">
                ...
                <div class="des">
                    <span>Fabric</span>
                    <h5>Men Stylist Cotton Kurta</h5>
                    <div class="star">
            ...
            <div class="pro">
                ...
                <div class="des">
                    <span>Cotton</span>
                    <h5>Yellow Men's Traditional wear Kurta</h5>
                    <div class="star">
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
            ...
            <div class="pro">
                ...
                <div class="des">
                    <span>Cotton</span>
                    <h5>Premium Cotton Half sleeves</h5>
                    <div class="star">
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
    ...
    <section id="banner" class="section-m1">
        <h4>Service Offer</h4>
        <h2>Up to <span>45% off</span> - All T-Shirts & Accessories</h2>
    ...
    <section id="sm-banner" class="section-p1">
        <div class="banner-box">
            ...
            <span>The Best Classic Dress on sale at Shopee</span>
