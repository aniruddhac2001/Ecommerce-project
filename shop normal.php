    ...
    <section id="header">
        ...
        <div>
            <ul id="navbar">
                ...
                <li><a class="active" href="shop normal.html">Shop</a></li>
                ...
                ?>
                <li><a href="Login2.php" class="cart">My Cart ( 0 )</a></li>
                <li><a href="Login2.php" class="button"> Login </a></li>
                <li><a href="Register.php" class="button2">Register</a></li>
            </ul>
        </div>
    </section>
